...
public class BebidasAdapter extends RecyclerView.Adapter<BebidasAdapter.ViewHolder>{
    ArrayList<FoodDomain> BebidasDomains;
    private List<FoodDomain> bebidaslist;

    public BebidasAdapter(ArrayList<FoodDomain> BebidasDomains) {

        this.BebidasDomains = BebidasDomains;
        this.bebidaslist = new ArrayList<>();
        bebidaslist.addAll(BebidasDomains);
    }
    ...
    public BebidasAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.viewholder_bebida,parent,false);
    ...
    public void onBindViewHolder(@NonNull BebidasAdapter.ViewHolder holder, int position) {
        holder.title.setText(BebidasDomains.get(position).getTitle());
        holder.fee.setText(String.valueOf(BebidasDomains.get(position).getFee()));

        int drawableReourceId=holder.itemView.getContext().getResources()
                .getIdentifier(BebidasDomains.get(position).getPic(),"drawable",
